...
#Cauchy Distribution
Given the shape of the data's histogram, and the underlying theoretical basis, let us investigate whether our data is well modelled by a Cauchy distribution.
```{r, echo= T}
hist(diffs, prob = TRUE, breaks = "FD", main = "Histogram of First Differences
     Cauchy Model", xlab = "First Differences")
```
We estimated the paramaters for Cauchy thanks to this paper by M. Mahdizadeh, and Ehsan Zamanzade:
