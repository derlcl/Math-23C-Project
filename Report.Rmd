...
#Exploratory Data Analysis
```{r}
# Visualize first differences of our Open price values
...
# resembles normal distribution with narrow concentration around sharp peak at mean and heavy tails, with more extreme negative values than positive values
qqnorm(diffs) # plot data with quantiles of the standard normal on the x-axis.
qqline(diffs) # add straight line through the first and third quartiles of our data, which does not seem to follow normal distribution at tails
# we could potentially model this with a heavy-tailed distribution, but what?
