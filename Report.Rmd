...
```
>>>>>>> fa482ff28c4d3314f76dd70d6a42d48f58aded82
...
=======
Further investigation is needed to confirm this hypothesis, and would require acces to an abundance of intraday data. But, the a deeper question that is not answered in this report is whether or not there a concerete relationship between the volume of data and our $\alpha$ paramater?
>>>>>>> fa482ff28c4d3314f76dd70d6a42d48f58aded82
...
```{r,echo=T, warning = F}
=======
#Now we will try sing fitdist parameters:
>>>>>>> 4d8ec1650887a8a7f4565592714bfcb9144c5e43
