...
As you can see, the stable distribution is a good fit for our Stock Price Changes and an excellent fit for our logarithmic stock price changes. We feel that with better paramater estimation techniques, we could better fit the distribution with even more accuracy. 
...
{hist(ks.stats, main = "Histogram of K-S Statistics", xlab = "K-S Stats")
...
{hist(ks.stats2, breaks = "fd", main = "Histogram of K-S Statistics", xlab = "K-S Stats")
abline(v = 0.05, col = "red")}
```
