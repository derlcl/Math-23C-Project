...
BOY <- subset(GDPb, format.Date(GDPb$DATE, "%m") == "01"); head(BOY) #selecting only dates for beginning of year
...
GOM <- numeric(length(BOY$GDPg)) #GOM here stands for Growth Over Mean
